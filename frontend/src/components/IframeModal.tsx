    ...
    >
      ...
      >
        ...
        <iframe
          ...
          // Least-privilege sandbox: scripts/forms/same-origin storage are needed for
          // MkDocs search and Google Forms submission; top-level navigation and new
          // windows/popups (Forms' own "next"/help links) stay allowed but confined to
          // this frame's context. referrerPolicy keeps our app URL (and any query
          // params) out of the embedded page's server logs.
