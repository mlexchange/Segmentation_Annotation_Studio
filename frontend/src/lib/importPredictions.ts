 ...
 *
 * Every returned shape is stamped `origin: 'predicted'` (see `ShapeOrigin` in
 * annotationStore) so it renders dashed and can be filtered separately from
 * hand-drawn shapes, same as iPred's committed predictions.
 */
