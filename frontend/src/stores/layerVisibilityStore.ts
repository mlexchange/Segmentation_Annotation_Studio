 ...
 *
 * Groups control image / features / probability / predictions / annotations /
 * manifold. Per-class keys under predictions and annotations (annotations also
 * sync with classStore.isVisible).
 */
